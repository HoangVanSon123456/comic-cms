      ...
      <Box className="bg-[#242526] w-2/3 text-white p-6 rounded-lg shadow-lg">
        ...
        <Box className="mt-6">
          ...
          <Typography className="text-gray-300 leading-relaxed">
            Truyện tranh <b>Dưỡng Địch Vi Hoạn</b> được cập nhật nhanh và đầy đủ
            nhất tại TruyenQQ. Bạn đọc đừng quên để lại bình luận và chia sẻ,
            ủng hộ TruyenQQ ra các chương mới nhất của truyện{" "}
            <b>Dưỡng Địch Vi Hoạn</b>.
          </Typography>
        </Box>
